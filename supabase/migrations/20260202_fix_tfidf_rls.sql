...
CREATE POLICY "Allow public tfidf_vector updates"
...
FROM pg_tables 
WHERE schemaname = 'public' AND tablename = 'researches';
...
CREATE POLICY "Enable tfidf_vector updates for service role"
ON public.researches
FOR UPDATE
TO anon
USING (true);
